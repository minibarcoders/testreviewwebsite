    ...
    <main className="flex-1">
      ...
      <div className="relative isolate overflow-hidden">
        ...
        <div className="absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-80">
          <div className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-indigo-300 via-purple-200 to-pink-300 opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]" />
        </div>
      ...
      {/* First Section - More Contrasting */}
      <div className="bg-white py-16">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="bg-gradient-to-br from-indigo-900 via-purple-900 to-indigo-900 rounded-3xl p-8 md:p-12 relative overflow-hidden">
            {/* Background Pattern */}
            ...
            {/* Glowing Orbs */}
            <div className="absolute top-0 right-0 w-96 h-96 bg-indigo-500/30 rounded-full filter blur-3xl -translate-y-1/2 translate-x-1/2"></div>
            <div className="absolute bottom-0 left-0 w-96 h-96 bg-purple-500/30 rounded-full filter blur-3xl translate-y-1/2 -translate-x-1/2"></div>

            <div className="flex flex-col md:flex-row gap-8 relative z-10">
              <div className="text-7xl font-light text-indigo-300/50">01</div>
              <div>
                <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">
                  Tech Reviews That Matter
                </h2>
                <p className="text-xl text-indigo-100 max-w-2xl">
                  Discover honest insights and in-depth analysis of the latest tech products.
                </p>
              </div>
            </div>
          </div>
                ...
                <div className="relative bg-white rounded-xl p-4">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center gap-2 text-sm text-slate-600">
                      ...
                      <span>•</span>
                      <time>{format(new Date(review.createdAt), 'MMM d, yyyy')}</time>
                    </div>
