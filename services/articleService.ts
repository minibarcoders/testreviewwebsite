...
export class ArticleService {
  ...
  static async getLatestBlogPosts(limit: number = 4): Promise<BlogArticle[]> {
    try {
      // First try to get from database
    ...
    try {
      ...
      if (dbReview) {
        return {
          ...
          author: dbReview.author.name,
          date: dbReview.createdAt.toLocaleDateString(),
    ...
    try {
      ...
      if (dbPost) {
        return {
          ...
          date: dbPost.createdAt.toLocaleDateString(),
